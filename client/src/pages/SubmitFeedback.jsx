        ...
        <div className="min-h-screen bg-deep-black flex items-center justify-center p-6 relative pt-32 pb-24">
            ...
            >
                ...
                <div className="text-center mb-8">
                    <MessageSquare className="w-12 h-12 text-ls-gold mx-auto mb-4 drop-shadow-[0_0_10px_rgba(0,229,255,0.4)]" />
                    <h2 className="text-3xl md:text-4xl font-black font-heading tracking-tight mb-2 text-white drop-shadow-lg">CREW <span className="text-transparent bg-clip-text bg-gradient-to-r from-ls-gold to-blue-500">FEEDBACK</span></h2>
                ...
                <div className="mb-8 p-5 bg-neon-red/5 border border-neon-red/20 rounded-lg">
                    ...
                    <div className="bg-black/40 p-4 rounded text-xs text-white/60 font-mono leading-loose border border-white/5 relative group">
                        <p><span className="text-ls-gold/70">Name:</span></p>
                        <p><span className="text-ls-gold/70">Reported Player:</span></p>
                        <p><span className="text-ls-gold/70">Date:</span></p>
                        <p><span className="text-ls-gold/70">Location / Event Name:</span></p>
                        <p><span className="text-ls-gold/70">Complaint Type:</span></p>
                        <p><span className="text-ls-gold/70">Description of the Incident:</span></p>
                        <p><span className="text-ls-gold/70">Requested Action:</span></p>
                        ...
                        <button 
                            ...
                            className="absolute top-3 right-3 p-2 bg-white/5 hover:bg-ls-gold/20 hover:text-ls-gold text-white/40 rounded transition-colors group-hover:opacity-100 flex items-center gap-2 text-[10px] uppercase font-bold"
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                    <div>
                        ...
                        <textarea 
                            ...
                            className="w-full bg-black/60 border border-white/10 rounded px-4 py-3 text-white focus:outline-none focus:border-ls-gold transition-colors resize-none" 
                    ...
                    <button 
                        disabled={loading}
                        type="submit" 
                        className={`w-full py-4 text-deep-black text-sm font-bold uppercase tracking-widest rounded transition-all shadow-[0_0_15px_rgba(0,229,255,0.3)] ${loading ? 'bg-ls-gold/50 cursor-not-allowed flex justify-center items-center gap-2' : 'bg-ls-gold hover:bg-ls-gold/80 hover:shadow-[0_0_25px_rgba(0,229,255,0.6)]'}`}
                    >
